...
{	
	...
	{ compression = {true, "binutils", "sysv-rc-conf", "thunar-archive-plugin", "xarchiver", "bzip2", "zip", "unzip", "p7zip-full", "unar"}}
}
...
{	{ ["headers"] = {"linux-headers-$(uname -r)", "build-essential", "gdb", "cmake"}},
	...
	{ ["clang3.9"] = {"clang-3.9", "libc++1", "libc++-dev", "libclang-3.9-dev", "liblldb-3.9-dev", false, "clang-format-3.9"}},
...
mount_packages =
{	{ gparted = {true, "sshfs", "bindfs", "gparted", "hdparm", "ntfs-3g", "cryptsetup", "dosfstools", "exfat-utils", "exfat-fuse", "gdisk", false, "gsmartcontrol", "cryptsetup-bin", "cryptmount", "jfsutils", "kpartx", "gpart", "parted", "attr", "mtools", "blktool", "btrfs-tools", "duperemove", "btrfs-heatmap", "fdupes"s}},
