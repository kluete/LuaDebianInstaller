...
{	{ icons = {true, "tango-icon-theme", "hicolor-icon-theme", "xfwm4-themes"}},
	...
	{ utils = {true, "geany", "geany-plugin-lua", "galculator", "mirage", "x11-xserver-utils", "xdiskusage", "ncdu", "mc", "mediainfo-gui", "usbutils", "xfce4-screenshooter", "lshw-gtk", false, "rsync", "qalculate-gtk"}},
...
{	{ ["headers"] = {"linux-headers-$(uname -r)", "build-essential", "gdb", "cmake"}},
	...
	{ ["lua"] = {"libreadline-dev", "lua-socket", "lua-posix", "libid3-tools", false, "lua5.3", "lua5.1-doc", "lua-sql-sqlite3"}},
